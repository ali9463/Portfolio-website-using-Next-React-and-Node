      ...
      <div className=" lg:gap-12 gap-y- items-center">
        ...
        <Image
          ...
          <div className="flex items-center gap-3">
            ...
            <Link className="flex items-center gap-1 hover:gap-3 rounded-full bg-[#FFA500] px-3 md:px-8 py-3 md:py-4 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold" role="button" target="_blank" href={personalData.resume}
            >
